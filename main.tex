...
\begin{itemize}
    ...
    \item evaluate the reliability and stability of LLM-based judgements used as ranking signals and, where RL is applied, as reward signals (RQ3); and
